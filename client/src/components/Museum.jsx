...
function Museum() {
  ...
  const [description, setDescription] = useState(
    "This is an description of an image"
  );
  ...
  const handleImageSubmit = async (e) => {
    ...
    if (!title || !description || !fileImage) {
      setMsg(
        "Failed to Upload - Please ensure Title, Description and File Images are properly entered."
      );
      return -1;
    }
        ...
        <div className="collectionForm w-full">
          ...
          >
            ...
            <label className="w-full flex flex-col">
              <div className="descriptionLabel ml-2 text-2xl">
                DESCRIPTION:{" "}
              </div>
              <textarea
                name="description"
