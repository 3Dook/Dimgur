...
const ImgBar = (props)=>{
    ...
    return (
        <div className='flex justify-between'>
            <button onClick={handleDeleteImg} className="shadow bg-red-400 hover:bg-red-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded mt-2 mb-2 ml-2">
            DELETE</button>
            <button onClick={()=>{
...
/*             window.location = "/";  */
    ...
    return (
      <div className="lex flex-col aspect-square bg-gray-100 mt-8 mx-8 drop-shadlow-lg border-solid border-[#585858] rounded-md hover:scale-[1.15] ease-in-out duration-300
        md:w-[calc(45%-2.5em)]
        lg:w-[25%]" id={props.id}>
            ...
            <img src={imgSrc} alt="failedImg" className='flex-1 w-full object-cover
            lg:h-[50%]'/>
